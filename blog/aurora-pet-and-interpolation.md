# 给小猫换一身极光皮：单角色多动作 + 光流补帧 + 资产门禁

> 需求 slug：`aurora-pet-and-interpolation` ｜ 关联：迭代自 [`agent-task-monitor`](./agent-task-monitor.md) · [`multi-client-and-control-panel`](./multi-client-and-control-panel.md) ｜ 版本：v0.6.0-dev
